...
/**
 * ViewModel for deck card in Dashboard view
 * Extends DeckDTO with formatted fields for UI
 */
export interface DeckCardViewModel extends DeckDTO {
  /**
   * Formatted relative time of last update
   * Examples: "2 godziny temu", "wczoraj", "3 dni temu"
   * Generated by date-fns formatDistanceToNow()
   */
  relativeTime: string;

  /**
   * Formatted flashcard count text
   * Examples: "0 fiszek", "1 fiszka", "25 fiszek"
   * Handles Polish plural forms
   */
...
export interface DashboardFilters {
  /**
   * Search query (client-side filtering by deck name)
   */
  searchQuery: string;
...
/**
 * Default filters for Dashboard view
 */
