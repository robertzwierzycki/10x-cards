...
describe('generateFlashcardsSchema', () => {
  ...
  describe('Real-world scenarios', () => {
    it('should validate educational paragraph', () => {
      const text = 'The Pythagorean theorem states that in a right-angled triangle, the square of the hypotenuse equals the sum of squares of the other two sides. Formula: a² + b² = c²';
      const result = generateFlashcardsSchema.safeParse({ text });
    ...
    it('should validate programming concept', () => {
      const text = 'React hooks are functions that let you use state and other React features without writing a class. Common hooks include useState, useEffect, and useContext.';
      const result = generateFlashcardsSchema.safeParse({ text });
    ...
    it('should validate historical fact', () => {
      const text = 'World War II lasted from 1939 to 1945. It was the deadliest conflict in human history, involving over 30 countries and resulting in 70-85 million fatalities.';
      const result = generateFlashcardsSchema.safeParse({ text });
    ...
    it('should validate language learning content', () => {
      const text = 'Common Spanish greetings:\n- Hola (Hello)\n- Buenos días (Good morning)\n- Buenas tardes (Good afternoon)\n- Buenas noches (Good evening/night)';
      const result = generateFlashcardsSchema.safeParse({ text });
